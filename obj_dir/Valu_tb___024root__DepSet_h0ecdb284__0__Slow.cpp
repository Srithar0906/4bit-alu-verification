...
#endif
            VL_FATAL_MT("tb/alu_tb.v", 3, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Valu_tb___024root___ctor_var_reset(Valu_tb___024root* vlSelf) {
    ...
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelf->alu_tb__DOT__a = VL_RAND_RESET_I(4);
    vlSelf->alu_tb__DOT__b = VL_RAND_RESET_I(4);
    vlSelf->alu_tb__DOT__opcode = VL_RAND_RESET_I(3);
    vlSelf->alu_tb__DOT__result = VL_RAND_RESET_I(4);
    vlSelf->alu_tb__DOT__carry = VL_RAND_RESET_I(1);
    vlSelf->alu_tb__DOT__expected = VL_RAND_RESET_I(4);
    vlSelf->alu_tb__DOT__pass_count = VL_RAND_RESET_I(32);
    vlSelf->alu_tb__DOT__fail_count = VL_RAND_RESET_I(32);
    vlSelf->alu_tb__DOT__rand_pass = VL_RAND_RESET_I(32);
    vlSelf->alu_tb__DOT__rand_fail = VL_RAND_RESET_I(32);
    }
