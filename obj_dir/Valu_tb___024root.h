...
class alignas(VL_CACHE_LINE_BYTES) Valu_tb___024root final : public VerilatedModule {
  public:
    ...
    CData/*3:0*/ alu_tb__DOT__a;
    CData/*3:0*/ alu_tb__DOT__b;
    CData/*2:0*/ alu_tb__DOT__opcode;
    CData/*3:0*/ alu_tb__DOT__result;
    CData/*0:0*/ alu_tb__DOT__carry;
    CData/*3:0*/ alu_tb__DOT__expected;
    CData/*0:0*/ __VstlFirstIteration;
    CData/*0:0*/ __VactContinue;
    IData/*31:0*/ alu_tb__DOT__pass_count;
    IData/*31:0*/ alu_tb__DOT__fail_count;
    IData/*31:0*/ alu_tb__DOT__rand_pass;
    IData/*31:0*/ alu_tb__DOT__rand_fail;
